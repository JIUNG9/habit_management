...
import com.module.dto.LoginForm;
import com.module.dto.UserDetailDto;
import com.module.entity.User;
import com.module.exception.ApiError;
import com.module.service.impl.UserServiceImpl;
import com.module.type.Role;

import com.module.security.jwt.JwtUtil;
import com.module.service.impl.EmailServiceImpl;
...
@Slf4j
    ...
    public ResponseEntity<Object> userSave(@RequestBody @Valid MemberForm memberForm) {
        ...
        com.module.entity.User user = com.module.entity.User.builder().name(memberForm.getName()).email(memberForm.getEmail()).password(memberForm.getPassword()).warningCount(0).role(Role.ROLE_NOT_VERIFIED).build();
    ...
    public ResponseEntity<Object> updateInfo(@PathVariable String content, @PathVariable String updateInfo, HttpServletRequest httpServletRequest) {
        ...
        if (httpServletRequest.getAttribute("email") != null) {
            com.module.entity.User user = userService.findUserByEmail((String) httpServletRequest.getAttribute("email"));
