...
public interface UserInGroupRepository extends JpaRepository<UserInGroup, Integer> {
    ...
    public List<SortByGroupUserNumberDto> countUserWithGroupInGroupsByGroup(@Param("group_id") List<com.module.entity.Group> group_id, Pageable pageable);

    @Query("SELECT u FROM UserInGroup u WHERE u.group = :group_id AND u.nickName = :nick_name")
    public UserInGroup findUserInGroupByNickNameAndGroup(@Param("group_id") com.module.entity.Group group_id, @Param("nick_name") String nick_name);
