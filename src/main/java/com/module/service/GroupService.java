...
public interface GroupService extends UserDetailsService {
    List<com.module.entity.Group> sortByTypeName(GroupType groupType, Integer page);
    ...
    com.module.entity.Group getGroupByAdminAndGroupName(String adminNickName , String groupName);
